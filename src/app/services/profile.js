...
export const profileApi = createApi({
    ...
    baseQuery:fetchBaseQuery({baseUrl:'https://ladymaggbeth-a003a-default-rtdb.firebaseio.com/'}),
    tagTypes:["userImage"],
    endpoints:(builder)=>({
...
export const {usePutImageMutation, useGetImageQuery, usePutUserLocationMutation,
    useGetUserLocationQuery} = profileApi
